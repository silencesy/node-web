    ...
    <view class="container">  
		...
		<view class="user-section">
			...
			<!-- <view class="vip-card-box">
				...
				<text class="e-m">便宜 快捷 健康</text>
				<text class="e-b">都是良心产品，值得购买。</text>
			</view> -->
		</view>
		...
		>
			...
			<view class="history-section icon">
				...
				<!-- <list-cell icon="icon-iconfontweixin" iconColor="#e07472" title="我的钱包" tips="您的会员还有3天过期" @eventClick='dkf'></list-cell> -->
				<list-cell icon="icon-dizhi" iconColor="#5fcda2" title="地址管理" @eventClick="navTo('/pages/address/address')"></list-cell>
				<!-- <list-cell icon="icon-share" iconColor="#9789f7" title="分享" tips="邀请好友赢10万大礼" @eventClick='dkf'></list-cell>
				<list-cell icon="icon-pinglun-copy" iconColor="#ee883b" title="晒单" tips="晒单抢红包" @eventClick='dkf'></list-cell> -->
				<list-cell icon="icon-shoucang_xuanzhongzhuangtai" iconColor="#54b4ef" title="我的收藏" @eventClick='dkf'></list-cell>
    ...
    export default {
        ...
        methods: {
			async money() {
				...
				const data = await this.Api.addItemType(params)
				console.log(data);
			},
			/**
			 * 统一跳转接口,拦截未登录路由
